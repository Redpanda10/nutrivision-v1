...
//     if (!detections.length) {
//       return res.status(200).json({ success: false, detectedFoods: [] });
//     }
...
//     const detectedFoods = uniqueFoods.map((food, index) => {
...
//           : 0,
//         nutrition:   fetchNutrition(food), // ← local lookup, no await needed

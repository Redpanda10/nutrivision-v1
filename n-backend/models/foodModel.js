...
//   {
//     caloriesKcal: { type: Number, min: 0, default: 0 },
...
//     candidates: {
//       type: [recognitionCandidateSchema],
//       default: [],
//     },
...
//       allergensMatched: { type: [String], default: [] },
//       warnings: { type: [String], default: [] },
//     },

//     /* =========================
//        🧠 LLM INSIGHTS (UPGRADED)
//     ========================= */
...
// foodHistorySchema.pre("save", function (next) {
//   if (this.recognition && !this.recognition.provider) {
//     this.recognition.provider = "yolo-onnx";
//   }
//   next();
// });
...
// foodHistorySchema.virtual("imageUrl").get(function () {
//   if (!this.capturedImage?.url) return null;

//   if (this.capturedImage.url.startsWith("http")) {
//     return this.capturedImage.url;
//   }
